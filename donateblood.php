...
<body>
          ...
          <form method="post" class="request-blood">
            <div class="row">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                <label for="date">Last Donated Date<span class="text-danger">*</span></label>
              ...
              <div class="text-center mt-3"><button type="submit" name="request-blood">Donate Blood</button></div>
            </form>
  ...
  <?php
        ...
        //   echo $date;
          ...
          $sql="insert into donorlist (id,donor_name,mobileno,blood_group,last_donated_date,available) 
          values (null,'$name','$mobileno','$bloodgroup','$date','Yes')";
            if($con->query($sql))
            {
